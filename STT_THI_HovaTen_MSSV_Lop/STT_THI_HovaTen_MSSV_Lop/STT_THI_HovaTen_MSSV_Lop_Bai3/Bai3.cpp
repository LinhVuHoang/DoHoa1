...
int main(void)
{
	...
	float planeVertices[] = {
		//tam giac 1
		//positions                             texture
		chieurong_Plane,-0.5f,chieudai_Plane,    1.0f,1.0f,
	   -chieurong_Plane,-0.5f,chieudai_Plane,   0.0f,1.0f,
	   -chieurong_Plane,-0.5f,-chieudai_Plane,  0.0f,0.0f,
	   //tam giac 2
	   //positions                                texture
	   chieurong_Plane,-0.5f,chieudai_Plane,     1.0f,1.0f,
	   -chieurong_Plane,-0.5f,-chieudai_Plane,   0.0f,0.0f,
	   chieurong_Plane,-0.5f,-chieudai_Plane,    1.0f,0.0f,
