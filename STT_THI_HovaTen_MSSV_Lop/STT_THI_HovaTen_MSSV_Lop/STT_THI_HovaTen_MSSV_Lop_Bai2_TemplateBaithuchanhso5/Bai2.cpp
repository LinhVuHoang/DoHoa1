...
//unbind VAO
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		{ 
					...
					//Ví dụ 1: Xoay tại 1 điểm P(-0.5, -0.5, 0)
						glm::mat4 matranT1 = glm::mat4(1.0f);
						matranT1 = glm::translate(matranT1, glm::vec3(0.5, 0.5, 0));// Bước 1: Dịch hình từ điểm P về gốc O(0,0,0)
						glm::mat4 matranR1 = glm::mat4(1.0f);
						matranR1 = glm::rotate(matranR1, -i*glm::radians(90.0f), glm::vec3(0.0, 0.0, 1.0));//Bước 2: Xoay hình tại gốc O(0,0,0) 1 góc
						glm::mat4 matranT2 = glm::mat4(1.0f);
						matranT2 = glm::translate(matranT2, glm::vec3(-0.5, -0.5, 0));// Bước 3: Dịch hình từ điểm gốc O(0,0,0) về P ); 
						glm::mat4 Trans = glm::mat4(1.0f);
						Trans = matranT2 * matranR1 * matranT1;
